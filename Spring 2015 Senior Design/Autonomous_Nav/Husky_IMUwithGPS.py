...
#       - Changed some tolerances for Husky (from Anaconda-based choices)
#       - TODO: Expose these choices at a package level
#
##########################################################################################
...
class IMU(object):
    ...
    def setup_data_file(self):
        ''' Set up the csv file to write to. 
         ...
         '''
        self.data_filename = 'imuData_withGPS' + datetime.datetime.now().strftime('%Y-%m-%d_%H%M%S')+'.csv'
