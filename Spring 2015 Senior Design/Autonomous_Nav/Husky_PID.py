...
class PID(object):
    ...
    def compute_output(self, desired_state, current_state, current_time = None, previous_time = None):
        ...
        logging.debug('Current State: {:.4f}\t Desired State: {:}'.format(current_state, desired_state))
...
#                 self.error += 360
            ...
            logging.debug('Error: {:}\t Error_dot: {:.4f}'.format(self.error, self.state_change))
