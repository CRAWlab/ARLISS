...
// Accelerometer
// "accel x,y,z (min/max) = -291/289  -296/304  -346/219"
#define ACCEL_X_MIN ((float) -291)
#define ACCEL_X_MAX ((float) 289)
#define ACCEL_Y_MIN ((float) -296)
#define ACCEL_Y_MAX ((float) 304)
#define ACCEL_Z_MIN ((float) -346)
#define ACCEL_Z_MAX ((float) 219)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -114)
#define MAGN_X_MAX ((float) 207)
#define MAGN_Y_MIN ((float) -182)
#define MAGN_Y_MAX ((float) 171)
#define MAGN_Z_MIN ((float) -169)
#define MAGN_Z_MAX ((float) 172)
...
#define GYRO_AVERAGE_OFFSET_X ((float) -37.03)
#define GYRO_AVERAGE_OFFSET_Y ((float) 24.72)
#define GYRO_AVERAGE_OFFSET_Z ((float) 15.72)
