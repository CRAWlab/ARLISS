...
class PID(object):
    ...
    def compute_output(self, desired_state, current_state, current_time = None, previous_time = None):
        ...
        print('Current State: {:.4f}\t Desired State: {:}'.format(current_state, desired_state))
        print('Current Time: {:.4f}\t Previous Time: {:.4f}'.format(self.current_time, self.previous_time))    
