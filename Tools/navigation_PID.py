...
# navigation_PID.py
#
# general PID module for use in navigation- suitable for "real-time" use
...
#
# Modified:
#   * 08/07/15 - JEV - joshua.vaughan@louisiana.edu
#       - initial generalization from Anaconda code
#
##########################################################################################
...
if __name__ == '__main__':
    ...
    plt.ylabel('Y label (units)',family='CMUSerif-Roman',fontsize=22,weight='bold',labelpad=10)
